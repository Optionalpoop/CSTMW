...
public class ManmadeInfinititeBlockBlock extends CoolStuffToMessWithModElements.ModElement {
	@ObjectHolder("cool_stuff_to_mess_with:manmade_infinitite_block")
	public static final Block block = null;
	public ManmadeInfinititeBlockBlock(CoolStuffToMessWithModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("manmade_infinitite_block");
		}
