...
public class FlamingBlockBlock extends CoolStuffToMessWithModElements.ModElement {
	@ObjectHolder("cool_stuff_to_mess_with:flaming_block")
	public static final Block block = null;
	public FlamingBlockBlock(CoolStuffToMessWithModElements instance) {
		super(instance, 50);
	}
