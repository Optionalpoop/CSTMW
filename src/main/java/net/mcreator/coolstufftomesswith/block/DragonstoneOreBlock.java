...
public class DragonstoneOreBlock extends CoolStuffToMessWithModElements.ModElement {
	@ObjectHolder("cool_stuff_to_mess_with:dragonstone_ore")
	public static final Block block = null;
	public DragonstoneOreBlock(CoolStuffToMessWithModElements instance) {
		super(instance, 72);
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == Blocks.OBSIDIAN)
				blockCriteria = true;
			if (blockAt.getBlock() == Blocks.PURPUR_BLOCK)
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("cool_stuff_to_mess_with:dragonstone_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("cool_stuff_to_mess_with:dragonstone_ore"),
					configuredFeature);
		}
	}
	@SubscribeEvent
