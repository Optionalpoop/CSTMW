...
public class DragonstoneBlockBlock extends CoolStuffToMessWithModElements.ModElement {
	@ObjectHolder("cool_stuff_to_mess_with:dragonstone_block")
	public static final Block block = null;
	public DragonstoneBlockBlock(CoolStuffToMessWithModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dragonstone_block");
		}
