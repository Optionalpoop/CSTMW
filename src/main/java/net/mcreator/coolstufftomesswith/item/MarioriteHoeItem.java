...
public class MarioriteHoeItem extends CoolStuffToMessWithModElements.ModElement {
	@ObjectHolder("cool_stuff_to_mess_with:mariorite_hoe")
	public static final Item block = null;
	public MarioriteHoeItem(CoolStuffToMessWithModElements instance) {
		super(instance, 116);
	}
