...
public class FlamingHoeItem extends CoolStuffToMessWithModElements.ModElement {
	@ObjectHolder("cool_stuff_to_mess_with:flaming_hoe")
	public static final Item block = null;
	public FlamingHoeItem(CoolStuffToMessWithModElements instance) {
		super(instance, 58);
	}
