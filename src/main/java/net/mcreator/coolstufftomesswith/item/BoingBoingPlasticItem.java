...
public class BoingBoingPlasticItem extends CoolStuffToMessWithModElements.ModElement {
	@ObjectHolder("cool_stuff_to_mess_with:boing_boing_plastic")
	public static final Item block = null;
	public BoingBoingPlasticItem(CoolStuffToMessWithModElements instance) {
		super(instance, 46);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("boing_boing_plastic");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A plastic that allows... bouncing??? How high does it g-"));
		}
