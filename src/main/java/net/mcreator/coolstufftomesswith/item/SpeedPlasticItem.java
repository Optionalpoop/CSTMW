...
public class SpeedPlasticItem extends CoolStuffToMessWithModElements.ModElement {
	@ObjectHolder("cool_stuff_to_mess_with:speed_plastic")
	public static final Item block = null;
	public SpeedPlasticItem(CoolStuffToMessWithModElements instance) {
		super(instance, 36);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("An artifact that can be used to unlock the power of SPEEEEEED"));
		}
