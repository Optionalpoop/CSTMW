...
public class HgfItem extends CoolStuffToMessWithModElements.ModElement {
	@ObjectHolder("cool_stuff_to_mess_with:hgf")
	public static final Item block = null;
	public HgfItem(CoolStuffToMessWithModElements instance) {
		super(instance, 93);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A what?"));
		}
	}
}
